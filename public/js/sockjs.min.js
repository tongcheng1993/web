...
!function (e) {
    ...
    return function i(s, a, l) {
        ...
        8: [function (e, t, n) {
            "use strict";
            var f = e("./utils/url"), r = e("./utils/event"), h = e("./facade"), o = e("./info-iframe-receiver"),
                d = e("./utils/iframe"), p = e("./location"), m = function () {
                };
        ...
        10: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), o = e("events").EventEmitter, i = e("./transport/sender/xhr-local"),
                s = e("./info-ajax");
        ...
        11: [function (n, o, e) {
            (function (u) {
                (function () {
                    "use strict";
                    var r = n("events").EventEmitter, e = n("inherits"), i = n("./utils/event"),
                        s = n("./transport/iframe"), a = n("./info-iframe-receiver"), l = function () {
                        };
        ...
        14: [function (x, _, e) {
            (function (w) {
                (function () {
                    "use strict";
                    x("./shims");
                    var r, l = x("url-parse"), e = x("inherits"), u = x("./utils/random"), t = x("./utils/escape"),
                        c = x("./utils/url"), i = x("./utils/event"), n = x("./utils/transport"),
                        o = x("./utils/object"), f = x("./utils/browser"), h = x("./utils/log"), s = x("./event/event"),
                        d = x("./event/eventtarget"), p = x("./location"), a = x("./event/close"),
                        m = x("./event/trans-message"), v = x("./info-receiver"), b = function () {
                        };
        ...
        17: [function (o, f, e) {
            (function (r) {
                (function () {
                    "use strict";
                    var i = o("events").EventEmitter, e = o("inherits"), s = o("../../utils/event"),
                        a = o("../../utils/url"), l = r.XMLHttpRequest, u = function () {
                        };
        ...
        22: [function (e, t, n) {
            "use strict";
            var r = e("inherits"), i = e("events").EventEmitter, o = e("../version"), s = e("../utils/url"),
                a = e("../utils/iframe"), l = e("../utils/event"), u = e("../utils/random"), c = function () {
                };
        ...
        23: [function (s, a, e) {
            (function (i) {
                (function () {
                    "use strict";
                    var e = s("inherits"), t = s("./lib/sender-receiver"), n = s("./receiver/jsonp"),
                        r = s("./sender/jsonp");
        ...
        30: [function (n, c, e) {
            (function (u) {
                (function () {
                    "use strict";
                    var e = n("inherits"), r = n("../../utils/iframe"), o = n("../../utils/url"),
                        i = n("events").EventEmitter, s = n("../../utils/random"), a = function () {
                        };
        ...
        31: [function (t, n, e) {
            (function (c) {
                (function () {
                    "use strict";
                    var r = t("../../utils/iframe"), i = t("../../utils/random"), s = t("../../utils/browser"),
                        o = t("../../utils/url"), e = t("inherits"), a = t("events").EventEmitter, l = function () {
                        };
        ...
        34: [function (r, u, e) {
            (function (l) {
                (function () {
                    "use strict";
                    var o = r("events").EventEmitter, e = r("inherits"), i = r("../../utils/event"),
                        t = r("../../utils/browser"), s = r("../../utils/url"), a = function () {
                        };
        ...
        42: [function (l, u, e) {
            (function (a) {
                (function () {
                    "use strict";
                    var e = l("inherits"), t = l("./lib/ajax-based"), n = l("./receiver/xhr"),
                        r = l("./sender/xhr-cors"), o = l("./sender/xhr-local"), i = l("../utils/browser");
        ...
        47: [function (t, p, e) {
            (function (d) {
                (function () {
                    "use strict";
                    var f = t("./event"), e = t("./browser"), h = function () {
                    };
                    p.exports = {
        ...
        57: [function (e, n, t) {
            (function (a) {
                (function () {
                    "use strict";
                    var d = e("requires-port"), p = e("querystringify"),
                        t = /^[\x00-\x20\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]+/,
                        m = /[\n\r\t]/g, i = /^[A-Za-z][A-Za-z0-9+-.]*:\/\//, l = /:\d+$/,
                        u = /^([a-z][a-z0-9.+-]*:)?(\/\/)?([\\/]+)?([\S\s]*)/i, v = /^[a-zA-Z]:/;
                    ...
                    function x(e, t) {
                        ...
                        var n, r = u.exec(e), o = r[1] ? r[1].toLowerCase() : "", i = !!r[2], s = !!r[3], a = 0;
                    ...
                    function _(e, t, n) {
                        ...
                        var r, o, i, s, a, l, u = y.slice(), c = typeof t, f = this, h = 0;
